...
export class ClosingPeriodService implements IServiceInterface{
    private url: string = environment.BASE_URL + "/closingperiods/";
  ...
  getLastPeriodOpen(): Observable<any> {
    return this._http.get(environment.BASE_URL + "/getlastperiodopen/").map(data => data);
  }
